...
const ProductInquiryForm = ({ product, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 transition-opacity duration-300">
      <div className="bg-white rounded-2xl p-6 sm:p-8 w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-2xl scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-gray-100 hide-scrollbar">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl sm:text-3xl font-semibold text-green-900 font-['Inter'] tracking-tight">
            Inquiry for {product?.name || 'Product'}
          </h2>
          <button
            onClick={onClose}
            className="text-green-700 hover:text-green-900 text-2xl font-bold transition-colors duration-200"
          >
            ×
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <div>
              ...
              <select
                ref={formRefs.unit}
                className="w-full px-4 py-2.5 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-400 focus:border-green-400 text-gray-900 font-['Inter'] text-sm bg-green-50/50 transition-all duration-200"
                defaultValue="units"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-400 focus:border-green-400 text-gray-900 font-['Inter'] text-sm bg-green-50/50 transition-all duration-200 placeholder-gray-400 resize-y"
              rows="4"
          ...
          <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 font-['Inter'] font-medium text-sm transition-all duration-200 shadow-md"
            >
              Submit Inquiry
            </button>
          </div>
